                ...
                <form method="post" action="/cookies">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= session('errors.name') ? 'is-invalid' : '' ?>" 
                               id="name" name="name" value="<?= esc(old('name'), 'attr') ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?= session('errors.description') ? 'is-invalid' : '' ?>" 
                                  id="description" name="description" rows="3"><?= esc(old('description')) ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control <?= session('errors.price') ? 'is-invalid' : '' ?>" 
                                           id="price" name="price" step="0.01" min="0.01" value="<?= esc(old('price'), 'attr') ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control <?= session('errors.stock') ? 'is-invalid' : '' ?>" 
                                       id="stock" name="stock" min="0" value="<?= esc(old('stock', 0), 'attr') ?>" required>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> Create Cookie
                        </button>
                        <a href="/cookies" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
